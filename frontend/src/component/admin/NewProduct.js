...
import { NEW_PRODUCT_RESET } from "../../constents/productConstents";
    ...
    <Fragment>
      ...
      <div className="dashboard">
        ...
        <div className="newProductContainer">
          <form className="createProductForm" oncType="multipart/form-data" onSubmit={createProductSubmitHandler}>
